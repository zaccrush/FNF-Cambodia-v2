...
import { Globe, Building2, Workflow, Users2, Shirt, Radio, Tv, Camera, Laptop, GraduationCap, Heart, ExternalLink } from 'lucide-react';
      ...
      <section className="py-20 border-b border-white/5 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-8">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <h2 className="text-brand-gold font-bold uppercase tracking-[0.3em] text-sm mb-6">Partnership Ecosystem</h2>
            <h1 className="text-6xl md:text-7xl font-display font-medium text-white mb-8 tracking-tighter uppercase leading-none">
              Strategic <br />
              <span className="text-[#444]">Alliances</span>
            </h1>
            <p className="text-[#888] text-xl font-medium leading-relaxed">
              FNF Cambodia is powered by a curated network of digital, governing, and technical partners dedicated to elevating the standard of Southeast Asian combat sports.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="p-8 border border-dashed border-white/10 rounded-3xl flex flex-col items-center justify-center text-center group hover:border-brand-gold/40 transition-colors">
               ...
               <h4 className="text-white font-display text-xl mb-2">Partner with FNF</h4>
               <p className="text-[#555] text-xs mb-6">Join our elite ecosystem</p>
               <Link to={`/${safeLang}/contact`} className="px-6 py-2 bg-[#1a1a1a] text-white rounded-xl text-[10px] font-bold uppercase tracking-widest hover:bg-brand-gold hover:text-black transition-all">
                  Inquire Now
               </Link>
            </div>
          </div>
         ...
         <div className="max-w-7xl mx-auto px-8 flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="max-w-2xl">
               <h2 className="text-black font-display text-4xl md:text-5xl font-bold uppercase tracking-tighter leading-none mb-4">
                  ...
                  <span className="opacity-60 italic">In the Arena</span>
               </h2>
               <p className="text-black/70 font-medium">
                  Direct access to over 20M+ broadcast reach and a passionate regional audience across Cambodia and Vietnam.
               </p>
            </div>
            <Link to={`/${safeLang}/contact`} className="w-full lg:w-auto px-12 py-5 bg-black text-white rounded-2xl font-bold hover:scale-105 transition-transform text-center shadow-2xl">
               Corporate Deck Request
            </Link>
         </div>
      </section>
    </div>
